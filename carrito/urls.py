...
urlpatterns = [
    ...
    path('comprarfromhome/', views.comprarfromhome, name='comprarfromhome'),
    path('comprarlista/', views.comprar_listacarrito, name='comprar_listacarrito'),
    
    
    path('mispedidos/', views.misPedidos, name='misPedidos'),
